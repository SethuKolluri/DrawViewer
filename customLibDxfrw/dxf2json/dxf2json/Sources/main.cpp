/*****************************************************************************
         ...
         Project build on top of the sample codes from libdxfrw libraries
         Library from https://github.com/LibreCAD/libdxfrw
...
bool extractData(std::string inName) {
    bool badState = false;
    ...
    badState = input->dumpData(inName, &fData);
    if (!badState) {
