...
#include "../../../libdxfrw-master/src/drw_interface.h"
...
public:
    dx_iface() { dxfW = NULL; }
    ~dx_iface() {}
    bool dumpData(const std::string& fileI, dx_data *fData);
    void writeEntity(DRW_Entity* e);


    //my functions
    void dumpLine(DRW_Line*,picojson::object& line);
    void dumpArc(DRW_Arc*, picojson::object& arc);
    void dumpCircle(DRW_Circle*, picojson::object& arc);
    void dumpPolyLine(DRW_Polyline*, picojson::object& polyLine);
    void dumpPolyLine(DRW_LWPolyline*, picojson::object& polyLine);
